        ...
        case ("ArgentinaLuz"):
            {
                ...
                precioFinalLampara = precioFinalCompra / cantidadDeLamparas;
                ...
                if (precioFinalCompra > 120) 
                {
                    ...
                    document.getElementById("precioDescuento").value = precioFinalLampara;
                    alert("Su total es $" + precioFinalCompraConIB + " esto incluye $" + adicionalIngresosBrutos + " de ingresos brutos");
                }
                else {
                    document.getElementById("precioDescuento").value = precioFinalLampara;
                    alert("Su total es $" + precioFinalCompra);
                }
                //Marcamos el final del caso.
                break;
            }
        case ("FelipeLamparas"):
            {
